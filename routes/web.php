...
Route::get('/diventa/revisore', [RevisorController::class, 'formRevisor'])->name('revisor_became');
...
// Ricerca annuncio
Route::get('/ricerca/annuncio', [PublicController::class, 'searchAnnouncements'])->name('announcement.search');
